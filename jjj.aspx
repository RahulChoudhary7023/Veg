<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="jjj.aspx.cs" Inherits="jjj" %>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-heading">Pages</li>
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
           <asp:LinkButton ID="LinkButton1" class="nav-link collapsed" PostBackUrl="~/Category_view.aspx" CausesValidation="false" runat="server">Category view</asp:LinkButton>
        </li>
     </ul>
               ...
               <table class="table table-dark">
                ...
                <ItemTemplate>
                  ...
                  <tr>
                    ...
                    <th scope="row" class="auto-style1"> <asp:Label ID="Label8" runat="server" Text='<%# Eval("CAid") %>'></asp:Label></th>
