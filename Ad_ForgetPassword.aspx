                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation">
                    <div class="col-12">
                        ...
                        <asp:TextBox ID="txt_number" runat="server" TextMode="Email" class="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Fill The Email" ControlToValidate="txt_number" ForeColor="#FF0066"></asp:RequiredFieldValidator>
                    </div>
