                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 needs-validation">
                                        <div class="col-12">
                                            ...
                                            <asp:RegularExpressionValidator ID="revPassword" runat="server" ControlToValidate="tx_NePass" ErrorMessage="at least 8 characters long and contain letters and/or numbers." CssClass="validator-message" ValidationExpression="^(?=.*[a-zA-Z0-9]).{8,}$" Display="Dynamic"></asp:RegularExpressionValidator>
                                        </div>
                                        <div class="col-12">
