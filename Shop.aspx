...
<head runat="server">
    ...
    <style>
        ...
        .page-header {
            ...
            margin-top: 70px; /* Adjusted space between navbar and header */
        }

        .page-header {
            position: relative;
            background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(../img/sub1.jpg);
            ...
            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                        <img src="img/sub1.jpg" class="d-block w-100" height="400" alt="..." />
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                        <img src="img/Fresh-ezgif.com-webp-to-jpg-converter.jpg" height="400" class="d-block w-100" alt="..." />
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Third slide label</h5>
                            <p>Some representative placeholder content for the third slide.</p>
                        </div>
                    ...
                    <div class="carousel-item">
                        <img src="img/cebc-4b73-8230-ezgif.com-webp-to-jpg-converter.jpg" class="d-block w-100" height="400" alt="..." />
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Third slide label</h5>
                            <p>Some representative placeholder content for the third slide.</p>
                        </div>
                                                ...
                                                <asp:LinkButton ID="LinkButton1" runat="server">
                                                    ...
                                                    <div class="rounded position-relative fruite-item">
                                                        ...
                                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                            ...
                                                            <h4>
                                                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("name") %>'></asp:Label></h4>
                                                            <p>
