<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Ad_Product_add.aspx.cs" Inherits="Ad_Product_add" %>
              ...
              <form>
                ...
                <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                     <asp:TextBox ID="txt_disc" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>

                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Tax</label>
                  <div class="col-sm-10">
                     <asp:TextBox ID="txt_tax" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">CAid</label>
                  <div class="col-sm-10">
                     <asp:TextBox ID="txt_Ctgid" class="form-control" runat="server"></asp:TextBox>
                  </div>
                </div>

                <div class="row mb-3">
                  <div class="col-sm-10">
                        <asp:LinkButton ID="LinkButton1" runat="server" class="" OnClick="add_Click">Save Change</asp:LinkButton>
                  </div>
                </div>
